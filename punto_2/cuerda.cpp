...
void progresemos(double* uviejito, double* uactual, double* unuevito, double constante, double enex);
void actualicemos(double* uviejito, double* uactual, double* unuevito, double enex);
...
int main(){
  ...
  while(t<tmax){
    for(i=0; i<200; ++i){
      ...
      progresemos(uviejito, uahora, uadelante, cons, enex);
      actualicemos(uviejito, uahora, uadelante, enex);
    }
    t = t+1;
  }
  //IMPRIME
